...
interface Props {
  ...
  isRangeEnd?: boolean;
  // The Stencil requester's lock mark: a half circle in the gutter the grid
  // keeps to the right of every swatch (Palette.css).
  isLocked?: boolean;
...
export function ColorButton({
  ...
  return (
    <button
      className={
        'ColorButton' +
        (fillCell ? ' ColorButton--fill' : '') +
        (isLocked ? ' ColorButton--locked' : '')
      }
      onClick={onClick}
