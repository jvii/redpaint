...
export const icons = {
  ...
  // The Workbench 1.3 Prefs paintbrush, recolored to the app theme: long
  // diagonal orange handle, grey ferrule band, and a fat white bristle blob
  // dipped in orange paint, with the little stroke it is painting under the
  // tip. The bulbous head against the thin handle is what makes it read as
  // a brush. (White bristles, not Workbench blue: the Brush gadget shows
  // this icon pressed-in on the blue face, where blue pixels would vanish.)
  brush: `
    .............KK.
    ............KOOK
    ...........KOOK.
