...
// Drag extent from the anchored top-left, at least 1x1. With Shift the original
// aspect ratio is kept (DPaint's constrained stretch): the dragged corner is
// the pointer's projection onto the brush's aspect diagonal, so it stays as
// close to the pointer as the constraint allows instead of overshooting on one
// axis.
function dragSize(
  anchor: Point,
  mousePos: Point,
