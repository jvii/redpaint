...
import { PaletteEditorColorSelectorTool } from '../../tools/PaletteEditorColorSelectorTool';
...
const selectorTools = {
  ...
  paletteEditorColorSelectorTool: new PaletteEditorColorSelectorTool(),
};
...
export type State = {
  ...
  // What was selected when a requester took the canvas over for picking, put
  // back when it closes: opening one must not silently disarm a brush
  // transform.
  selectorToolBeforeCanvasPick: SelectorToolId | null;
};
...
export const state: State = {
  ...
  selectorToolBeforeCanvasPick: null,
};
